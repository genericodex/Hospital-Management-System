...
public class AppointmentServices {
    ...
    public static void createAppointment() throws ParseException {
        ...
        Date appointmentDate = dateTimeFormat.parse(dateTimeStr);
        String reason = getStringInput("Enter reason for visit: ");

        Appointment appointment = service.createAppointment(patient, doctor, appointmentDate, reason);
